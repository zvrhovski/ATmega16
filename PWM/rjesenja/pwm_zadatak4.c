...
int main(void){
	...
	while(1)
	{
		...
		OCR1A = ADC5 * ICR1 / 1023 / 10 + 1000;
		OCR1B = ADC5 * ICR1 / 1023 / 10 + 1000;
		
		
		// zasto ovo nece raditi kako treba?
		lcd_clrscr();
		lcd_home();
